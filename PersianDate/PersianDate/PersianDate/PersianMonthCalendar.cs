namespace FreeControls
{
    ...
    public partial class PersianMonthCalendar : Control
    {
        ...
        public PersianMonthCalendar()
        {
            ...
            todayLink.Text = persianValue.ToString("امروز: DD dd MM yyyy");
        ...
        private void DrawToday(Graphics gr, PersianDate curDate)
        {
            if (this.showToday)
            {
                string date = curDate.ToString("DD dd MM yyyy");
        ...
        private void FillCells(PersianDate date)
        {
            ...
            PersianDate tempDate = date.GetLastSaturday();
        ...
        private void monthMitem_Click(object sender, EventArgs e)
        {
            try
            {
                this.Value = new PersianDate(persianValue.Year, Convert.ToInt32(((ToolStripMenuItem)sender).Tag), persianValue.Day);
            }
            catch (ArgumentException) { }
        }
        ...
        private void headerPanel_Click(object sender, EventArgs e)
        {
            if (yearNumericUpDown.Visible)
            {
                ...
                try
                {
                    this.Value = new PersianDate(((int)yearNumericUpDown.Value), persianValue.Month, persianValue.Day);
                }
                catch (ArgumentException) { }
            }
        }

    ...
    public partial class LoginLibraryManagment : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (txtLoginUserName.Text.Trim().Length > 0 && txtLoginPassword.Text.Trim().Length > 0)
            {
                ...
                objCommand.CommandText = "select FisrName,shomareshenasname from RegisterManager where FisrName= N'" + txtLoginUserName.Text + "' AND shomareshenasname='" + txtLoginPassword.Text + "'";

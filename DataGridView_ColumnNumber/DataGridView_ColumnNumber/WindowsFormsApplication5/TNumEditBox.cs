...
namespace WindowsFormsApplication5
{
    ...
    public class TTextBoxEx : TextBox
    {
        ...
        public TTextBoxEx()
        {
            ...
            base.ReadOnly = false;
            base.TextChanged+=new System.EventHandler(this.textBox_TextChanged);
        }
...
//-----------------------TextChanged-----------------------------------------
        ...
        private void textBox_TextChanged(object sender, EventArgs e)
        {
            ...
            base.Text = Decimal.Parse(base.Text, NumberStyles.AllowThousands).ToString("N", nfi);
    ...
    public class TNumEditBox : TTextBoxEx
    {
        ...
        private const int m_MaxValueLength = 30; // decimal can be 28 bits.
        ...
        private int m_decimalLength = 0;//111
        ...
        public string DecimalLength
        {
            get
            {
                return m_decimalLength.ToString();
                
            }
            set
            {
                if (m_decimalLength.ToString() != value)
                {
                    if (int.Parse(value) < 0 ||int.Parse(value) > m_MaxDecimalLength)
                    {
                        m_decimalLength = 0;
                    }
                    else
                    {
                        m_decimalLength = int.Parse(value);
                    }
                    this.SetValueFormatStr();

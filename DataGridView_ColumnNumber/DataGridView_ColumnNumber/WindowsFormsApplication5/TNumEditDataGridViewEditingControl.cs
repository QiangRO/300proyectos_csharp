...
namespace WindowsFormsApplication5
{
    ...
    public class TNumEditDataGridViewCell : DataGridViewTextBoxCell
    {
        ...
        protected override bool SetValue(int rowIndex, object value)
        {
            ...
            try
            {
                val = value;// Math.Round(System.Convert.ToDecimal(value), m_decimalLength);
            }
            catch { }
        ...
        {
            //initialFormattedValue = EditingTNumEditBox;
            ...
            if (numEditBox != null)
            {
                ...
                numEditBox.DecimalLength = this.DecimalLength.ToString();
        ...
        public override void DetachEditingControl()
        {
            ...
            if (numEditBox != null)
            {
                Value = numEditBox.Text; // avoid interferences between the editing sessions
            }

            base.DetachEditingControl();//$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$4
        }
                                                    ...
                                                    DataGridViewDataErrorContexts context)
        {
            ...
            if (value == null ||value.ToString()==""  || string.IsNullOrEmpty(formattedText))
            {
                return baseFormattedValue;
            }

            string unformattedDecimal = System.Convert.ToString(value); // 123.1 to "123.1"
            string formattedDecimal = System.Convert.ToString(formattedText); // 123.1 to "123.12" if DecimalLength is 2

            if (unformattedDecimal != "0" && m_showNullWhenZero)//if (unformattedDecimal == 0.0m && m_showNullWhenZero)
            {
            ...
            {
                return value; //return formattedDecimal.ToString("F" + m_decimalLength.ToString());
            }
        ...
        internal void SetDecimalLength(int rowIndex, int value)
        {
            ...
            {
                this.EditingTNumEditBox.DecimalLength = value.ToString();
            }
        }
